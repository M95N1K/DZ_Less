...
namespace DZ_Less4_3
{
    class OneDimensionalArrays
    {
        ...
        public OneDimensionalArrays(int length, int number)
        {
            arr = new int[length];
        ...
        public OneDimensionalArrays(int length, int min, int max)
        {
        ...
        public OneDimensionalArrays(int length, int start, int step, int nul = 0)
        {
            arr = new int[length];
